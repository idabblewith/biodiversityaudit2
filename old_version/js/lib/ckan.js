	...
	my.Client.prototype.datastoreQuery = function (queryObj, cb) {
		...
		this.action("datastore_search", actualQuery, function (err, results) {
			...
			var fields = _.map(results.result.fields, function (field) {
				field.type =
					field.type in my.ckan2JsonTableSchemaTypes
						? my.ckan2JsonTableSchemaTypes[field.type]
						: field.type;
				return field;
			});
			var out = {
...
(function (my) {
	...
	var Deferred =
		typeof jQuery !== "undefined" && jQuery.Deferred
			...
			? _.Deferred
			: function () {
					throw new Error("No Deferred implementation available");
			  };
